...
export function appDisplayName(source) {
    ...
    if (value === "codex")
        return "Codex CLI";
    if (value === "claudecode" || value === "claude")
        return "Claude Code";
    if (value === "gemini")
        return "Gemini CLI";
    if (value === "opencode")
...
export function sourceIconName(source) {
    ...
    if (key.includes("codex"))
        return "codex.svg";
    if (key.includes("claudecode") || key.includes("claude"))
        return "claudecode.svg";
    if (key.includes("gemini"))
        return "geminicli.svg";
...
export function modelIconName(row) {
    ...
    if (key.includes("deepseek"))
        return "deepseek.svg";
    if (key.includes("llama") || key.includes("meta"))
        return "meta.svg";
    ...
    if (key.includes("cohere") || key.includes("command-r"))
        return "cohere.svg";
    if (key.includes("perplexity") || key.includes("sonar"))
        return "perplexity.svg";
    if (key.includes("kimi") || key.includes("moonshot"))
        return "moonshot.svg";
    if (key.includes("gpt") || key.includes("openai"))
        return "openai.svg";
    if (key.includes("opencode") || row.source === "opencode")
        return "opencode.svg";
    if (key.includes("openrouter") || row.source === "zed")
...
export function modelInitials(row) {
    ...
    if (key.includes("openrouter") || row.source === "zed")
        return "OR";
    if (row.model_family === "OpenAI")
        return "AI";
    if (row.model_family === "Claude")
        return "C";
    if (row.model_family === "Gemini")
        return "G";
    if (row.model_family === "Qwen")
        return "Q";
    return "?";
}
...
export function iconClassName(name, baseClass) {
    ...
    const contrastClass = key === "openai.svg" || key === "openrouter.svg" || key === "opencode.svg"
        ? " icon-on-dark"
        : "";
...
export function renderAppIcon(source) {
    ...
    if (!icon)
        return '<span class="app-dot"></span>';
...
export function renderModelIcon(row) {
    ...
    if (!icon)
        return `<div class="model-glyph">${initials}</div>`;
